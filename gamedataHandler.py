...
lastSecond = 0
buffer = 10
json_file = '/var/www/html/webdata/data.json'
...
while (True):
    ...
    if (second != lastSecond):
        ...
        # Update the time value in the dictionary
        playerInfo["time"] = second
    ...
    if (second == 0 and lastSecond > buffer):
        ...
        playerInfo["username"] = playerUsername
